...
if __name__ == '__main__':
    ...
    roberta_squad_range_log_prune_score_quant_score = get_em_quantbits(\
        './quantized_params/scores/roberta-squad-range-log-clamped-midval-prune-score-quantize-score-max', avg_score=True)
